...
class KSResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        ks_res.update(
            ...
            ks_purchase_discount_account=int(self.env['ir.config_parameter'].sudo().
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].sudo().set_param('ks_enable_discount', self.ks_enable_discount)
        if self.ks_enable_discount:
            self.env['ir.config_parameter'].sudo().set_param('ks_sales_discount_account', self.ks_sales_discount_account.id)
            self.env['ir.config_parameter'].sudo().set_param('ks_purchase_discount_account', self.ks_purchase_discount_account.id)
